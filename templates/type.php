...
<?php include '../lib/Database.php'; ?>
	...
	if ($action=='add') {
		...
		$sql="update type set title_name='$name' WHERE tid=$id";
		//echo $sql;
		pg_query($dbhost, $sql);
	}if ($action=='delete') {
		
		$sql="delete from type where tid=$getid";
		//echo $sql;
		pg_query($dbhost, $sql);
	}
	$result = pg_query($dbhost, "SELECT * FROM type");
								...
								<div class="modal" id="myModaladd">
									  <div class="modal-dialog">
									    <div class="modal-content">
									      ...
									      <!-- Modal Header -->
									      <form method="POST" action="type.php?action=add">
									...
									<div class="modal" id="myModal<?php echo $row[0] ?>">
									  <div class="modal-dialog">
									    <div class="modal-content">
									      ...
									      <!-- Modal Header -->
									      <form method="POST" action="type.php?action=update">
									      <div class="modal-header">
									        <h4 class="modal-title">Update Type id: <?php echo $row[0] ?></h4>
									        <button type="button" class="close" data-dismiss="modal">&times;</button>
									      </div>
									...
									<div class="modal" id="myModaldelete<?php echo $row[0] ?>">
									  <div class="modal-dialog">
									    <div class="modal-content">
									      ...
									      <div class="modal-header">
									        <h4 class="modal-title">Delete Type id: <?php echo $row[0] ?></h4>
									        <button type="button" class="close" data-dismiss="modal">&times;</button>
									      </div>
									      ...
									      <!-- Modal footer -->
									      <div class="modal-footer">
									      	<a class="btn btn-danger" href="type.php?action=delete&id=<?php echo $row[0]?>">DELETE</a>
