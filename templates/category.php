...
<?php include '../lib/Database.php'; ?>
	...
	if ($action=='add') {
		...
		$sql="update category set category_name='$name' WHERE cid=$id";
		//echo $sql;
		pg_query($dbhost, $sql);
	}if ($action=='delete') {
		
		$sql="delete from category where cid=$getid";
		//echo $sql;
		pg_query($dbhost, $sql);
	}
	$result = pg_query($dbhost, "SELECT * FROM category");
									...
									<div class="modal" id="myModal<?php echo $row[0] ?>">
									  <div class="modal-dialog">
									    <div class="modal-content">
									      ...
									      <div class="modal-header">
									        <h4 class="modal-title">Update Category id: <?php echo $row[0] ?></h4>
									        <button type="button" class="close" data-dismiss="modal">&times;</button>
									      </div>
									...
									<div class="modal" id="myModaldelete<?php echo $row[0] ?>">
									  <div class="modal-dialog">
									    <div class="modal-content">
									      ...
									      <div class="modal-header">
									        <h4 class="modal-title">Delete category id: <?php echo $row[0] ?></h4>
									        <button type="button" class="close" data-dismiss="modal">&times;</button>
									      </div>
									      ...
									      <!-- Modal footer -->
									      <div class="modal-footer">
									      	<a class="btn btn-danger" href="category.php?action=delete&id=<?php echo $row[0]?>">DELETE</a>
