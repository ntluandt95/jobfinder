...
<?php include '../lib/Database.php'; ?>
	...
	if ($action=='add') {
		...
		$sql="insert into Job_skills values (default,$jid,$tid)";
		...
		$sql="delete from Job_skills where jsid=$getid";
		//echo $sql;
		pg_query($dbhost, $sql);
	}
	...
	function selectjobtype($dbhost,$jid){
		if ($jid==0) {
			$query="SELECT * FROM skills natural join Job_skills natural join job";
		}
		else{
			$query="SELECT * FROM skills natural join Job_skills natural join job where jid=$jid";
		}
	...
	$resulttype = pg_query($dbhost, "SELECT * from skills");
	if (!$result)
	{
								...
								<div class="modal" id="myModaladd">
									  <div class="modal-dialog">
									    <div class="modal-content">
									      ...
									      <!-- Modal Header -->
									      <form method="POST" action="jobskills.php?action=add&jid=<?php echo $jobid ?>">
									      <div class="modal-header">
									        <h4 class="modal-title">Add Job Skills</h4>
									      ...
									      <div class="modal-body">									        	
												...
												<select name="tid" class="form-control">
														<?php while ($rowtype = pg_fetch_array($resulttype)){?>
															...
															<option value="<?php echo $rowtype["sid"]; ?>"><?php echo $rowtype["skill_name"]; ?></option>
									...
									<div class="modal" id="myModaldelete<?php echo $row[0] ?>">
									  <div class="modal-dialog">
									    <div class="modal-content">
									      ...
									      <!-- Modal footer -->
									      <div class="modal-footer">
									      	<a class="btn btn-danger" href="jobskills.php?action=delete&id=<?php echo $row[0]?>">DELETE</a>
